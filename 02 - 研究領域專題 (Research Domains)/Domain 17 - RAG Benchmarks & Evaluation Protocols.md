...
| :--- | :--- | :---: | :--- | :--- | :--- |
| **Parsing / Layout** | **[[03 - 論文庫 (Literature Notes)/06 - Benchmarks & Evaluation/(KDD 2022-08) DocLayNet - A Large Human-Annotated Dataset for Document-Layout Analysis|DocLayNet]]** | `dataset` | 11 類版面區域（Paragraph, Table, Title 等）人工邊框標註 (80,863 頁) | **不測**文本內容語意理解與檢索準確度（純視覺版面分割）。 | [[03 - 論文庫 (Literature Notes)/06 - Benchmarks & Evaluation/(KDD 2022-08) DocLayNet - A Large Human-Annotated Dataset for Document-Layout Analysis|文獻筆記]] · [KDD 2022](https://doi.org/10.1145/3534678.3539043) |
| **多頁視覺問答** | **[[03 - 論文庫 (Literature Notes)/06 - Benchmarks & Evaluation/(PR 2023-12) Hierarchical Multimodal Transformers for Multi-Page DocVQA|MP-DocVQA]]** | `dataset` / `benchmark_paper` | 46,236 組多頁（至多 20 頁）工業與行政文件問答與頁碼定位 | 依賴多模態跨頁視覺特徵，純文字檢索無法直接評估其視覺排版推理能力。 | [[03 - 論文庫 (Literature Notes)/06 - Benchmarks & Evaluation/(PR 2023-12) Hierarchical Multimodal Transformers for Multi-Page DocVQA|文獻筆記]] · [PR 2023](https://doi.org/10.1016/j.patcog.2023.109833) |
| **長文論文循證問答** | **[[03 - 論文庫 (Literature Notes)/06 - Benchmarks & Evaluation/(NAACL 2021-06) QASPER - A Dataset of Information-Seeking Questions and Answers Anchored in Research Papers|QASPER]]** | `dataset` / `benchmark_paper` | 5,049 組資訊尋求型學術長文問答，具備跨段落 Evidence Spans | 專注於 NLP 單篇科學論文，不評測跨文件檢索與多輪對話。 | [[03 - 論文庫 (Literature Notes)/06 - Benchmarks & Evaluation/(NAACL 2021-06) QASPER - A Dataset of Information-Seeking Questions and Answers Anchored in Research Papers|文獻筆記]] · [NAACL 2021](https://doi.org/10.18653/v1/2021.naacl-main.365) |
| **Entity / Relation**| **DocRED** | `dataset` | 跨句子命名實體、關係與指代消解 Gold | **不測**企業特定操作語意（無 F/R/D/A/P/C/T 標註）。 | [GitHub](https://github.com/thunlp/DocRED) |
| **Event Extraction** | **[[03 - 論文庫 (Literature Notes)/04 - Knowledge & Graph RAG/(EMNLP 2020-11) MAVEN - A Massive General Domain Event Detection Dataset\|MAVEN]]** | `dataset` | 4,480 篇文檔，168 類事件觸發詞與論元 | **不測**深層跨章節商業合約時效狀態與條件依賴。 | [[03 - 論文庫 (Literature Notes)/04 - Knowledge & Graph RAG/(EMNLP 2020-11) MAVEN - A Massive General Domain Event Detection Dataset\|文獻筆記]] · [GitHub](https://github.com/THU-KEG/MAVEN-dataset) |
...
| **動態衝突與時效** | **[[03 - 論文庫 (Literature Notes)/06 - Benchmarks & Evaluation/(ACL 2026-08) Re3 - Relevance and Recency Retrieval for Mitigating Temporal Hallucination\|Re² Bench (Re³)]]** | `dataset` / `benchmark_paper` | 時效敏感事實問答，注入過期舊版本干擾項 (1.3M 規模) | 不能推廣為「最新文檔永遠為正解」的萬能證明。 | [[03 - 論文庫 (Literature Notes)/06 - Benchmarks & Evaluation/(ACL 2026-08) Re3 - Relevance and Recency Retrieval for Mitigating Temporal Hallucination\|文獻筆記]] · [ACL Anthology](https://aclanthology.org/2026.acl-long.1180/) |
...
| **事實優先報告** | **[[03 - 論文庫 (Literature Notes)/05 - Memory & Agents/(ACL 2026-08) EviReport - From Reasoned Outlines to Evidence Tracked Long-Form Reports\|EviReportBench]]** | `benchmark_paper` / `dataset` | 事實準確度（Accuracy）與覆蓋率（Coverage）多維評估 | 包含多模態測項，純文字研究需排除視覺測項。 | [[03 - 論文庫 (Literature Notes)/05 - Memory & Agents/(ACL 2026-08) EviReport - From Reasoned Outlines to Evidence Tracked Long-Form Reports\|文獻筆記]] · [ACL Findings](https://aclanthology.org/2026.findings-acl.1397/) |
| **報告級宏觀邏輯** | **[[03 - 論文庫 (Literature Notes)/06 - Benchmarks & Evaluation/(ACL 2026-08) ReportLogic - Evaluating Logical Quality in Deep Research Reports|ReportLogic]]** | `benchmark_paper` / `dataset` | 篇章結構邏輯、論證嚴密性評估（LogicJudge） | 官方 Repo 標註資料集尚待審核釋出，不可虛標為已能完整重現。 | [[03 - 論文庫 (Literature Notes)/06 - Benchmarks & Evaluation/(ACL 2026-08) ReportLogic - Evaluating Logical Quality in Deep Research Reports|文獻筆記]] · [ACL 2026](https://arxiv.org/abs/2602.18446) |
| **專業長篇報告** | **[[03 - 論文庫 (Literature Notes)/05 - Memory & Agents/(ACL 2026-08) AnalystBench - Benchmarking Professional Long-Form Report Generation with Web-Mined Multimodal Tasks\|AnalystBench]]** | `benchmark_paper` / `dataset` | 20 項專業多模態長篇報告任務，評估 Expert Checklist 與 Groundedness | 純文字設定需排除視覺模態；閉源模型依賴 agentic 工作流增益顯著 (+20pt) | [[03 - 論文庫 (Literature Notes)/05 - Memory & Agents/(ACL 2026-08) AnalystBench - Benchmarking Professional Long-Form Report Generation with Web-Mined Multimodal Tasks\|文獻筆記]] · [ACL Findings](https://aclanthology.org/2026.findings-acl.1420/) |
| **時效敏感動態問答** | **[[03 - 論文庫 (Literature Notes)/06 - Benchmarks & Evaluation/(ACL 2024-08) FreshLLMs - Refreshing Large Language Models with Search Engine Augmentation\|FreshQA (FreshLLMs)]]** | `benchmark_paper` / `dataset` | 600 組快變/慢變/假前設動態問題，評估搜尋引擎整合時效性 | 評估需搭配動態搜尋 API；嚴格匹配模式下幻覺率極高 | [[03 - 論文庫 (Literature Notes)/06 - Benchmarks & Evaluation/(ACL 2024-08) FreshLLMs - Refreshing Large Language Models with Search Engine Augmentation\|文獻筆記]] · [ACL 2024](https://aclanthology.org/2024.acl-long.464/) |
| **真實自主 Agent 環境** | **[[03 - 論文庫 (Literature Notes)/06 - Benchmarks & Evaluation/(ICLR 2024-05) WebArena - A Realistic Web Environment for Building Autonomous Agents\|WebArena]]** | `benchmark_paper` / `dataset` | 4 大真實 Docker 網站環境，812 項端到端目標驅動任務 | 需完整本地容器架構支援，以功能性終態驗證防範路徑偏差 | [[03 - 論文庫 (Literature Notes)/06 - Benchmarks & Evaluation/(ICLR 2024-05) WebArena - A Realistic Web Environment for Building Autonomous Agents\|文獻筆記]] · [OpenReview](https://openreview.net/forum?id=oKn9Agc2ta) |
