...
| **專業長篇報告** | **[[03 - 論文庫 (Literature Notes)/06 - Benchmarks & Evaluation/(ACL 2026-08) AnalystBench - Benchmarking Professional Long-Form Report Generation with Web-Mined Multimodal Tasks\|AnalystBench]]** | `benchmark_paper` / `dataset` | 20 項專業多模態長篇報告任務，評估 Expert Checklist 與 Groundedness | 純文字設定需排除視覺模態；閉源模型依賴 agentic 工作流增益顯著 (+20pt) | [[03 - 論文庫 (Literature Notes)/06 - Benchmarks & Evaluation/(ACL 2026-08) AnalystBench - Benchmarking Professional Long-Form Report Generation with Web-Mined Multimodal Tasks\|文獻筆記]] · [ACL Findings](https://aclanthology.org/2026.findings-acl.1420/) |
