...
>
> 💡 **本 Vault 已為您完整建立 107 篇頂級核心學術論文筆記與 104 篇原始 PDF**，並在文獻筆記中無縫嵌入雙向連結，可直接在 Obsidian 內點擊閱讀！
...
### 四、核心論文庫 (107 篇文獻筆記與 104 篇原始 PDF)
...
1. **開啟 Graph View (關係圖譜)**：按下快速鍵 `Ctrl/Cmd + G`，您可以直觀看到 17 個領域專題如何透過雙向連結與 107 篇論文及核心報告交織成網。
