...
| :--- | :--- | :---: | :---: | :--- | :--- | :--- | :--- | :---: |
| **版面解析** | **DocLayNet** | `dataset` | 多模態 (PDF 圖像 + 文字) | 11 類版面區域人工標註邊框 (Bounding Boxes) | 文件結構解析、多欄排版還原 | **不能**證明文字內容語意理解與生成能力 | [GitHub DocLayNet](https://github.com/DS4SD/DocLayNet) | `verified` |
...
| **報告級宏觀邏輯** | **ReportLogic** | `dataset` / `benchmark_paper` | 純文字 (Text) | Macro / Expositional / Structural Logic (LogicJudge) | 篇章結構嚴密性與論證邏輯審計 | 官方 Repo 標註資料集尚待審核釋出 | [ACL 2026](https://aclanthology.org/2026.acl-long.384/) · [Repo](https://github.com/Polaris-JZ/ReportLogic) | `verified` |
